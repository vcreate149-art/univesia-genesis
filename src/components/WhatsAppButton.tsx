...
export const WhatsAppButton = () => {
  ...
  return (
    <a href={url} target="_blank" rel="noopener noreferrer" className="fixed bottom-[calc(1rem+env(safe-area-inset-bottom))] right-4 sm:bottom-6 sm:right-6 z-40 w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[hsl(142_70%_45%)] flex items-center justify-center shadow-lg hover:scale-110 transition-transform group" aria-label={t("whatsapp.aria")}>
